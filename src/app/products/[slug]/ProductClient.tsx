      ...
      <div className="container mx-auto px-4 max-w-[1400px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:flex-1 min-w-0 flex flex-col">
            ...
            <div className="mb-6">
              <h1 className="text-[14px] sm:text-[24px] md:text-[28px] lg:text-[32px] font-bold leading-tight text-[#111111]">{product.name}</h1>
              ...
              {viewMode === '3d' && product.model_url ? (
                ...
                >
                  ...
                  <img
                    ...
                    alt={product.name}
                    className="w-full h-full object-contain bg-[#F3F6F5] transition-opacity duration-300"
                  />
