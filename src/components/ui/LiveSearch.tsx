    ...
    <div className="relative w-full">
      <form onSubmit={handleSubmit} className="relative flex items-center w-full">
        ...
        <input
          ...
          className="w-full h-[58px] pl-14 pr-16 rounded-2xl border border-white/80 bg-white/80 shadow-[0_8px_40px_rgba(36,184,108,0.10)] backdrop-blur-xl text-base text-[#0D1A12] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#24B86C]/60 focus:shadow-[0_8px_40px_rgba(36,184,108,0.18)] transition-all"
        ...
        {/* Submit button — rounded-xl green square as per reference */}
        <button
          type="submit"
          className="absolute right-2 top-1/2 -translate-y-1/2 w-11 h-11 rounded-xl bg-gradient-to-br from-[#24B86C] to-[#11998E] flex items-center justify-center shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200 z-10"
          aria-label="Search"
        >
